...
public class myEventDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ob = (myEventModel) getIntent().getSerializableExtra("product");
                ...
                db.collection("event").document(ob.getId()).delete()
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void unused) {
                                Toast.makeText(myEventDetails.this, "Deleted successfully", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(myEventDetails.this, UserMainActivity.class);
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                ...
                                Toast.makeText(myEventDetails.this, "event deletion is not successful", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(myEventDetails.this, UserMainActivity.class);
                                startActivity(intent);
